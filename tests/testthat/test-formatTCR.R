...
tcr_long <- c("T cell receptor alpha locus", "T cell receptor beta locus",
              "T cell receptor alpha locus", "T cell receptor beta locus",
              "T cell receptor gamma locus", "T cell receptor delta locus",
              "T cell receptor gamma locus", "T cell receptor gamma variable 9",
