...
This sort vignette shows how to standardize the names of the antibody-derived tags in
...
## Matching using the CITEseq data set
...
cite-seq data set could be matched to each antigen.  Here we see that only
AnnexinV and the isotype controls could not be matched by name only
...
```{r, message = FALSE}
# We load the tidyverse to simplify data.frame manipulations.
library(tidyverse)
...
# TO DO: NOT ON HOW THE ALT_IDs ARE ASSIGNED
