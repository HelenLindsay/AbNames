...
```{r}
# To make it easier to view the query table, we will first remove some unneeded
# columns
citeseq <- dplyr::select(citeseq, Antigen, Study)

# Apply the default transformation sequence and make a query table in long format
query_df <- AbNames::makeQueryTable(citeseq, ab = "Antigen",
                                    id_cols = c("Antigen", "Study"))

# Select just the columns of interest (for viewing the table)
query_df <- query_df %>%
...
## Multiple matches example CD11a, CD18



"CD11a.CD18-Wu_2021_b"
"CD270 (HVEM, TR2)-Hao_2021" - three different IDs
"KIR2DL5" matches two genes HGNC:16345 HGNC:16346
"CD279 (PD-1)-Mimitou_2021_cite_and_dogma_seq"
"DR3 (TRAMP)-Liu_2021"
"KLRG1 (MAFA)-Qian_2020"
